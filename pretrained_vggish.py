...
from torch import hub # type: ignore

from dataset import * 
import vggish_params

# Sourced archived repo from https://github.com/harritaylor/torchvggish/blob/master 
...
class VGGish(VGG):
    def __init__(self, urls, device=None, pretrained=True,postprocess=True, progress=True):
        """
        Constructs a VGGish model.
        Unlike source, the Dataset class from dataset.py is used to preprocess data instead of doing it in the model. 
